...
PYBIND11_MODULE(robotmq_core, m)
{
    ...
    py::class_<RMQClient>(m, "RMQClient")
        ...
        .def("pop_data", py::overload_cast<const std::string &, int32_t>(&RMQClient::pop_data), py::arg("topic"), py::arg("n"))
        .def("pop_data", py::overload_cast<const std::string &, int32_t, double>(&RMQClient::pop_data), py::arg("topic"), py::arg("n"), py::arg("timeout_s"))
        .def("put_data", py::overload_cast<const std::string &, const pybind11::bytes &>(&RMQClient::put_data), py::arg("topic"), py::arg("data"))
        .def("put_data", py::overload_cast<const std::string &, const pybind11::bytes &, double>(&RMQClient::put_data), py::arg("topic"), py::arg("data"), py::arg("timeout_s"))
        ...
        .def("request_with_data", py::overload_cast<const std::string &, const pybind11::bytes &>(&RMQClient::request_with_data), py::arg("topic"), py::arg("data"))
        .def("request_with_data", py::overload_cast<const std::string &, const pybind11::bytes &, double>(&RMQClient::request_with_data), py::arg("topic"), py::arg("data"), py::arg("timeout_s"));
    ...
    py::class_<RMQServer>(m, "RMQServer")
        ...
        .def("peek_data", &RMQServer::peek_data, py::arg("topic"), py::arg("n"))
        .def("pop_data", &RMQServer::pop_data, py::arg("topic"), py::arg("n"))
